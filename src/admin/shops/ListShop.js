  ...
  return (
    <div className='row'>
      ...
      <div className='card col-md-10 p-4'>
        ...
        <h1 className='text-center mb-5'>All Shops</h1>
        <div className='d-flex justify-content-end'>
      <a className='btn btn-secondary btn-sm p-2 m-2' href='/admin/add-shop'>Add Shop</a>
      </div>
        ...
        <table class="table table-striped" id="table" data-url="json/data1.json" data-filter-control="true" data-show-search-clear-button="true">
          ...
          <tbody>
            <tr>
              <th scope="row">1</th>
              <td>AVITA Brand Shop</td>
              <td>Balaji Computers</td>
              <td>5, Tarun enclave, Pitampura, New Delhi - 110034</td>
              <td>balajishop@gmail.com</td>
              <td>+91-9871254608</td>
              <td>09am - 11pm (Mon-Fri) </td>
              <td><Link to="/admin/shop-details"><i class="fa fa-eye" aria-hidden="true"></i></Link></td>
            </tr>
            <tr>
              <th scope="row">2</th>
              <td>AVITA Brand Shop</td>
