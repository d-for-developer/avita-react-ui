  ...
  return (
    <div className='row'>
      ...
      <div className='card col-md-10 p-4'>
        <h3 className='my-4'>Add Service Center</h3>
        ...
        <form>
          <div className='row'>
            <div className='col-md-6 mt-5'>
              <div class="mb-3">
                <label for="exampleInputType" class="form-label">Service Center Name</label>
                <input type="text" placeholder="Service Center Name" className="form-control" name="code" />
              </div>
              <div className='row mb-3'>
                ...
                <div className='col-md-6 mt-2 float-right'>
                   <Link to='/admin/add-type/'><button className='btn btn-outline-dark mt-4'>Add New</button></Link>
                  </div>
              </div>

              <div class="mb-3">
                <label for="exampleInputType" class="form-label">Service Center Address</label>
                <textarea placeholder="Service Center Address" rows="3" className="form-control" name="code" ></textarea>
              </div>
            ...
            <div className='col-md-6 mt-5'>
              ...
              <div class="mb-3">
                ...
                <textarea class="form-control" placeholder="Service Center Description" rows="6"></textarea>
              </div>
