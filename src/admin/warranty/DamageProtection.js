...
export default function DamageProtection() {
  return (
    ...
    <div className='card col-md-10 p-4'>
      <h1 className='text-center mb-5'>Damage Protection Plan</h1>
      <table class="table table-striped" id="table" data-url="json/data1.json" data-filter-control="true" data-show-search-clear-button="true">
        ...
        <tbody>
          <tr>
            ...
            <td>18 Months Warrnaty<br /><small>12 months standard warranty and<br />6 months Damage Protection Plan</small></td>
            <td>Warranty Expires on:<br /> 31st March 2023</td>
            <td>Damage Protection Plan on:<br /> 01st April 2022</td>
            <td>Active</td>
