  ...
  return (
    <div className='row'>
      ...
      <div className='card col-md-10 p-4'>
        ...
        <h1 className='text-center mb-5'>Add New Product Number</h1>
        <div className='row col-md-12'>
          ...
          <div class="col-md-6 mb-3">
            <form>
              ...
              <div className='row'>
                <div class="col-md-9 mb-3">
                  <label for="exampleInputProductNo" class="form-label">Product Number</label>
                  <input type="text" class="form-control" id="exampleInputProductNo" aria-describedby="usernameHelp" />
              ...
              <div className='row'>
                ...
                <div class="col-md-9 mb-3">
                  ...
                  <textarea row="4" class="form-control" id="exampleInputProductNo" aria-describedby="usernameHelp" />
                  </div>
              </div>
