...
export default function ListGrid() {
  return (
    ...
    <div className='card col-md-10 p-4'>
        ...
        <h1 className='text-center mb-5'>List Grid</h1>

        <div className='d-flex justify-content-end'>
          <a className='btn btn-secondary btn-sm p-2 m-2' href='/admin/add-grid'>Add Grid</a>
        </div>
        <table class="table table-striped" id="table" data-url="json/data1.json" data-filter-control="true" data-show-search-clear-button="true">
            ...
            <thead>
                ...
                <tr>
                    ...
                    <th scope="col">Mobile View</th>
                    <th scope="col">Desktop View</th>
            ...
            <tbody>
                <tr>
                    ...
                    <td>Active</td>
                    <td><Link to="/admin/grid-details"><i class="fa fa-eye" aria-hidden="true"></i></Link></td>
                </tr>
                <tr>
                    <th scope="row">2</th>
                    <td><img src={MobBanner} style={{ width: 50 }} ></img></td>
